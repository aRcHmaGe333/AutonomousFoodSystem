...
// Avoid committing real secrets. Prefer setting TEST_JWT_SECRET in CI or local env.
process.env.JWT_SECRET = process.env.TEST_JWT_SECRET || 'changeme_test_jwt_secret';
